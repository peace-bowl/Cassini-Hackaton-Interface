...
export const translations = {
  en: {
    ...
    'layer.ndwi.desc': 'Maps water bodies and surface moisture content.',
    'layer.ndvi.name': 'NDVI',
    'layer.ndvi.desc': 'Vegetation health and density near water sources.',
    'layer.ndsi.name': 'NDSI',
    'layer.ndsi.desc': 'Snow cover and ice detection in alpine regions.',
    'layer.swir.name': 'SWIR',
    'layer.swir.desc': 'False-color highlighting soil moisture and vegetation health.',
    'layer.index': 'INDEX',
  ...
  ro: {
    ...
    'layer.ndwi.name': 'NDWI',
    'layer.ndwi.desc': 'Cartografiază corpurile de apă și umiditatea suprafeței.',
    'layer.ndvi.name': 'NDVI',
    'layer.ndvi.desc': 'Sănătatea și densitatea vegetației lângă sursele de apă.',
    'layer.ndsi.name': 'NDSI',
    'layer.ndsi.desc': 'Detectarea zăpezii și gheții în regiunile alpine.',
    'layer.swir.name': 'SWIR',
    'layer.swir.desc': 'Culori false evidențiind umiditatea solului și sănătatea vegetației.',
    'layer.index': 'INDEX',
