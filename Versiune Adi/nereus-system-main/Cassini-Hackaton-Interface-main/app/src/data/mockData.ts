...
export const mockAlerts: WaterAlert[] = [
  ...
  },
  {
    ...
    description: 'Flash flood warning triggered by upstream precipitation data. 48mm rainfall in 3 hours.',
    location: 'Fabric District — South Bank',
  },
  {
    id: 'WA-006',
    type: 'Drought',
    ...
    description: 'Below-average precipitation for 21 consecutive days. Agricultural impact assessment pending.',
    location: 'Giroc Agricultural Zone',
  },
  {
    id: 'WA-007',
    type: 'Infrastructure',
    ...
    description: 'Storm drain capacity at 87% in sector 4. Overflow risk if precipitation exceeds 15mm/hr.',
  ...
  },
  {
    ...
    description: 'Chemical spill alert: industrial effluent detected in tributary. pH levels at 4.2.',
    location: 'Freidorf Industrial',
  },
  {
    id: 'WA-009',
    type: 'Soil Moisture Anomaly',
    ...
    description: 'Minor soil moisture variance detected in park irrigation zone. Within acceptable parameters.',
  ...
  },
  {
    ...
    description: 'Major pipeline rupture detected via acoustic sensor array. Emergency repair dispatched.',
    location: 'Blvd. Liviu Rebreanu',
  },
  {
    id: 'WA-011',
    type: 'Other',
    ...
    description: 'Routine sensor calibration anomaly at monitoring station RO-TM-12. Data flagged for review.',
    location: 'Mehala Water Station',
  },
  {
    id: 'WA-012',
    type: 'Flood',
    ...
    description: 'Moderate river level increase on Bega downstream. Current level: 0.6m above normal.',
    location: 'Bega Canal — East',
  },
  {
    id: 'WA-013',
    type: 'Drought',
    ...
    description: 'Soil moisture deficit reaching critical threshold for winter wheat in agricultural parcel AG-7.',
    location: 'Southern Agricultural Belt',
  },
  {
    id: 'WA-014',
    type: 'Infrastructure',
    ...
    description: 'Water treatment facility filter efficiency at 82%. Scheduled maintenance recommended.',
    location: 'Aquatim Treatment Plant',
  },
  {
    id: 'WA-015',
    type: 'Contamination',
    ...
    description: 'Elevated turbidity readings in distribution network sector 7. Source investigation underway.',
    location: 'Iosefin Distribution Hub',
  },
  {
    id: 'WA-016',
    type: 'Leak',
    ...
    description: 'Minor seepage detected at valve junction V-234. Non-critical, scheduled for next maintenance cycle.',
    location: 'Strada Memorandului',
  },
  {
    id: 'WA-017',
    type: 'Flood',
    ...
    description: 'Localized surface water accumulation due to blocked drainage. Municipal services notified.',
    location: 'Piața Unirii Area',
  },
  {
    id: 'WA-018',
    type: 'Other',
    ...
    description: 'Citizen report: unusual water discoloration in residential tap supply. Sample collected for lab analysis.',
    location: 'Calea Șagului Residential',
  },
];
