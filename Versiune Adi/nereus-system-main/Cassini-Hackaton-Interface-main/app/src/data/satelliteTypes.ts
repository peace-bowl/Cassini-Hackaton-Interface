...
export const SATELLITE_LAYERS: SatelliteLayerConfig[] = [
  ...
  },
  {
    ...
    description: 'Shows the water elevation and measures how turbid (cloudy) the water is.',
    propertyKey: 'ndwi',
    getColor: ndwiColor,
    legendStops: [
  ...
  },
  {
    ...
    description: 'Monitors algae levels and identifies muddy environments in and around the water.',
    propertyKey: 'ndvi',
    getColor: ndviColor,
    legendStops: [
  ...
  },
  {
    ...
    description: 'Used specifically to track and map vegetation in both natural and urban areas.',
